...
public abstract class ProviderBase {
    ...
    static private ProviderBase tpbInstance = null;
    ...
    private POSFactory bean = new POSFactory();
    ...
    public abstract int AddUser(String userName, String email,String password,int isLocked,String createDate,String createBy,int roleID);
    public abstract int EditUser(String userName, String email,int isLocked,String createDate,String createBy,int roleID);
