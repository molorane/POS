...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jpanelHome.add(panelUsers, "card3");
        ...
        jmiUsers.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/menuicons/stDependent.png"))); // NOI18N
        jmiUsers.setText("Users");
    ...
    private void btnAddOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddOrderItemActionPerformed
       ...
       if(currentProduct != null){
           if(txtItemQuantity.getText().length() > 0){
              ...
              errorMessage("Specify quantity before adding an item!"); 
           }
           ...
           try{
            ...
            errorMessage("No product to add. Search for product to add first!");
        }
    ...
    private void btnEditOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditOrderItemActionPerformed
        ...
        if(rowSelected != -1){
            ...
            errorMessage("No order item selected. Please select an order item before editing!");
        }
    ...
    private void tbnProcessOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbnProcessOrderActionPerformed
        ...
        if(paymentAmount.length() > 0){
            if(!OrderBLL.isOrderEmpty()){
                try{
                    ...
                    if(actualPaymentAmount >= OrderBLL.getOrderTotal()){
                        ...
                        if(success){
                            ...
                            errorMessage("Error! Order could not be successfully processed!"); 
                        }
                    }else{
                       errorMessage("Order total of "+
                ...
                errorMessage("Order is empty, please add items before processing!");
            }
        }else{
            errorMessage("Pefore processing the order, you have to specify the actual payment of the customer "
                    + " on payment field!");
        }
    ...
    private void btnSaveProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveProductActionPerformed
        ...
        if(productAdded > 0){
            ...
            successMessage("Success: Product added!");
        }else{
            errorMessage("Error: Product not added!");
        }
    ...
    private void btnEditProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditProductActionPerformed
        ...
        if(productEdited > 0){
            ...
            successMessage("Success: Product edited!");
        }else{
            errorMessage("Error: Product not edited!");
        } 
    ...
    private void btnDeleteProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteProductActionPerformed
        ...
        if(productDeleted > 0){
            ...
            successMessage("Success: Product deleted!");
        }else{
            errorMessage("Error: Product not deleted!");
        } 
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(pnlOrder != null){
            ...
            warningMessage("Before viewing the order details, select the order first!");
        }
